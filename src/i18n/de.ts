const de = {
  ...
  setup_subtitle: 'Elektronisches Spiel',
  ...
  rules_summary_singular:
    'Jeder Spieler hat 4 farbige Tasten. Befolge den Befehl in der Mitte. Wer zuerst alle Tasten leert, gewinnt die Runde. Wer zuerst {winsToWin} Runde gewinnt, gewinnt das Spiel!',

  // Game screen
  command: 'BEFEHL',
  round: 'RUNDE',
  direction: 'RICHTUNG',
  instant_uno: 'SOFORT UNO',
  pass_left: 'LINKS',
  pass_right: 'RECHTS',
  wins: 'SIEGE',
  player: 'SPIELER',
  ...
  // Overlays
  round_winner: 'RUNDENSIEGER',
  game_winner: 'SPIELSIEGER',
  player_wins_round: '{player} gewinnt die Runde!',
  player_wins_game: '{player} gewinnt das Spiel!',
  continue_btn: 'WEITER',
