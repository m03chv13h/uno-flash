const fr = {
  // Setup screen
  setup_title: 'UNO FLASH',
  setup_subtitle: 'Jeu Électronique',
  ...
  rules_summary_singular:
    'Chaque joueur a 4 boutons colorés. Suivez la commande affichée au centre. Le premier à vider tous ses boutons gagne la manche. Le premier à gagner {winsToWin} manche gagne la partie !',

  // Game screen
  command: 'COMMANDE',
  round: 'MANCHE',
  direction: 'DIRECTION',
  instant_uno: 'UNO INSTANTANÉ',
  pass_left: 'GAUCHE',
  pass_right: 'DROITE',
  wins: 'VICTOIRES',
  player: 'JOUEUR',
  ...
  cmd_4: '4',
  cmd_skip: 'PASSER',
  cmd_reverse: 'INVERSER',
  cmd_draw: 'PIOCHER',
  cmd_wild: 'JOKER',
  cmd_instant_uno: 'UNO INSTANTANÉ !',

  // Overlays
  round_winner: 'GAGNANT DE LA MANCHE',
  game_winner: 'GAGNANT DE LA PARTIE',
  player_wins_round: '{player} gagne la manche !',
  player_wins_game: '{player} gagne la partie !',
